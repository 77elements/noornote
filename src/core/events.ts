...
export interface AppEvents {
  ...
  /** A bookmark's read-state changed. id = single card marked read (click);
   *  all = bulk "mark as read" or reset; neither = NIP-78 sync merge. */
  'bookmark:read': { id?: string; all?: boolean };
  'tribe:updated': void;
