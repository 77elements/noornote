...
export class FontSizeSwitcher {
  ...
  private createElement(): HTMLElement {
    ...
    container.innerHTML = `
      ...
      <button class="btn btn--passive btn--fontsizeswitcher font-size-switcher__btn--decrease" type="button" title="Decrease font size">&minus;</button>
      <button class="btn btn--passive btn--fontsizeswitcher font-size-switcher__btn--increase" type="button" title="Increase font size">+</button>
    `;
