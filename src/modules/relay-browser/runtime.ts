...
export class RelayBrowserRuntime
  implements ModuleRuntime<RelayBrowserModuleApi>
{
  private orchestrator:
    | import('../../services/orchestration/RelayBrowserOrchestrator').RelayBrowserOrchestrator
    | null = null;

  async init(_ctx: ModuleContext): Promise<void> {
    const { RelayBrowserOrchestrator } = await import(
      '../../services/orchestration/RelayBrowserOrchestrator'
    );
