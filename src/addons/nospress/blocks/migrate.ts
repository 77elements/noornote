 ...
 *
 * Pure function, no side effects. Used by NospressService.getPageV2().
 */

import type { NospressListData } from '../../../services/NospressService';
import { newId, type Block, type NospressPageV2 } from './types';

export function migrateV1ToV2(v1: NospressListData, mountedFolders: string[]): NospressPageV2 {
  const blocks: Block[] = [];
  ...
  const v2: NospressPageV2 = { version: 2, blocks };
